...
| Sound level compensation | `PSSURLEV ?` | `PSSURLEV OFF/LIT/MED/HEV` | `^PSSURLEV\s*(OFF\|LIT\|MED\|HEV)` | DynEQ sub-setting (menu: under Dynamic EQ). Tokens + behavior measured live via remote-change broadcast capture; writes echo instantly |
